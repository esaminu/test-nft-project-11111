...
return data !== null ? (
  <>
        ...
        (listing, i) => {
          ...
          return (
            <div className="d-flex flex-column gap-1">
              ...
              >
                <Widget
                  src="fhthgfgdhfgh.testnet/widget/mainnet_widget_test"
                  props={{
                    nft: {
    ...
    <div class="py-4">
      <Widget src="fhthgfgdhfgh.testnet/widget/mainnet_widget_test" props={{src: "mintbase.near/widget/BuiltWithMintbase"}} />
    </div>
  </>
) : (
  <p>loading...</p>
